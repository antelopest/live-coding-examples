...
Напишите функцию <b>findSubstring(substring, arr)</b>, 
которая принимает строку substring и массив строк arr, 
и возвращает массив строк, которые содержат подстроку substring.
